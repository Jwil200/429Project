		...
		while (!input.equals("exit")) {
			...
			switch (command) {
				...
				case "terminate":
					...
					else{System.err.println("Error: Invalid input, terminate <id>");
					...
					if (cmdArgs.length >=3) {
						...
						chat.send(Integer.valueOf(cmdArgs[1]), cmdArgs[2]);
						}
					}
						else{System.err.println("Error: Invalid input, send <id> <msg>");
